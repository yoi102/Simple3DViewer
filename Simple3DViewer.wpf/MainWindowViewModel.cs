...
internal partial class MainWindowViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private ViewerDraggerType leftButtonDragger = ViewerDraggerType.Orbit;
    ...
    [ObservableProperty]
    private ViewerDraggerType rightButtonDragger = ViewerDraggerType.Pan;
    ...
    private async Task OpenFile()
    {
        ...
        using var _ = dialogService.ShowProgressDialog();

        var newOdaVisualizeContext = await Task.Run(() =>
        {
            var odaVisualizeContext = new OdaVisualizeContext();
